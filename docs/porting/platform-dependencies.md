...
| GX/G2/BG | `src/gx_layers.c`, `src/bg_window.c` | display modes, tile backgrounds, windows | 4bpp NSCR text BG decode implemented; layer state and other modes pending |
