...
| `OS_TIMER_3`, timer registers | `src/timer.c` | monotonic timing | platform monotonic ticks | pending |
...
| `OS_AllocFromMainArena*`, `NNS_Fnd*` | `src/system.c`, `src/heap.c` | arenas/heaps | portable heap backend | pending |
