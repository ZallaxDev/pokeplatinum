...
| `NNS_G2d*`, OAM manager | sprite/graphics modules | resource parsing and sprites | portable decoders plus sprite batches | texture/sprite/alpha submission proven; resource decoders pending |
